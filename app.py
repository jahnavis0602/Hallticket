from flask import Flask, request, send_file, render_template, redirect, url_for, session, send_from_directory
...
def add_student():
    ...
    if usn in generated_usns:
        return " Hall ticket for this USN has already been generated!", 400
    ...
    photo.save(photo_path)
     ...
     # Build the accessible URL for the photo
    server_url = "http://127.0.0.1:5000"  # Replace with your actual server address
    photo_url = f"http://127.0.0.1:5000/uploads/photo.filename"
